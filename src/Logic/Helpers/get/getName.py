#from Protocol.LaserMessageFactory import LogicLaserMessageFactory
...
class whatIsIt:
    ...
    def getPacketName(packetID):
        try:
            packet = whatIsIt.packets[packetID]
        except KeyError:
            return "NaN"
        return packet
    ...
    def getCommandName(commandID):
        try:
            command = whatIsIt.commands[commandID]
        except KeyError:
            return "NaN"
        return command